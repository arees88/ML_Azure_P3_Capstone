...
The best of these models will be deployed as an endpoint. The model endpoint is then tested to verify that it is working as intented by sending HTTP requests. 
